<?php
  ...
  if(isset($_SERVER['HTTP_REFERER']) && !strstr($_SERVER['HTTP_REFERER'], "single_post_index.php")){
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST" ) //inserting post to db
  {
      ...
      if($result == ""){
        header("Location: single_post_index.php?id=$_GET[id]");
        die;
      }else{
    ...
    <div class="profile-section">
       ...
       <div class="delete-modal">
         ...
         <nav class="home-header"> 
            ...
            <div class="close-del">
              <?php if($ROW['parent'] == 0){ ?>
                <a href="index.php" id="closeButton">+</a>
              <?php }else{ ?>
                <a href="single_post_index.php?id=<?php echo $ROW['parent'] ?>" id="closeButton">+</a>
              <?php }?>  
            </div>
            <?php if($ROW['parent'] != 0){ ?>
                <h2> Replies</h2> 
            ...
            <?php } ?>
              <?php
                ...
                if(is_array($ROW)){
                  ...
                  if(is_array($ROW)){
                    ...
                    if($ROW['parent'] == 0){
                      Include("P_post_comment_index.php");  
                    }else{
                      $COMMENT = $ROW;
              ...
              ?> <!-- view original post -->
              <?php if($ROW['parent'] != 0){ ?>
                <a href="single_post_index.php?id=<?php echo $ROW['parent'] ?>">
